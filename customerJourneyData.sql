...
Script to clean the duplicate values and handelling the null value by the average aggregator and extracting usefull information
...
/***********************************
Cleaning and removing the inconsistent data such as NULL and replacing it with average duration values
